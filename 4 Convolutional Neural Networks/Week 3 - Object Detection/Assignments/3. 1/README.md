...
<div class="cmlToHtml-content-container" style="white-space: pre-wrap">
    <p>Welcome to the Week 3 programming assignment of Course 4 in the Deep Learning Specialization! In this assignment,
        you'll implement object detection on a car dataset using the very powerful YOLO model.&nbsp;</p><img
        src="images/Screen-Shot-2020-12-04-at-4.16.01-PM.png"
        alt="" />
    <p>Instructions:</p>
